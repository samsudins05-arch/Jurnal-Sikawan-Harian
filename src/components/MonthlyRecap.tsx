      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs">
        ...
        {onOpenMasterData && (
          <button
            ...
            className="flex items-center gap-1.5 text-emerald-700 hover:text-emerald-900 hover:underline font-semibold cursor-pointer self-start md:self-auto shrink-0"
          >
            <span>Data Pegawai</span>
                    ...
                    className={`shrink-0 w-11 py-2 rounded-xl text-center transition-all cursor-pointer border ${
                      isSelected
                        ? isWeekend
                          ...
                          : 'bg-emerald-700 text-white border-emerald-800 shadow-xs font-bold scale-105'
                        : isWeekend
          ...
          {filteredJournals.length === 0 ? (
            <div className="text-center py-14 px-4 space-y-3">
              ...
              <p className="text-xs text-slate-400 max-w-md mx-auto">
                Silakan beralih ke tab <strong className="text-emerald-700">Jurnal Harian</strong> untuk memilih tanggal dan mulai mengisi aktivitas kerja.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <div className="space-y-1.5 flex-1">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="text-[11px] font-mono px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-800 font-semibold border border-emerald-200">
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-semibold rounded-lg border border-emerald-200 transition-colors cursor-pointer"
                      >
